...
from .funcs import fulfill_order
...
def cart():
    ...
    return render_template('cart.html', items=items, price=round(price, 4), price_ids=price_ids, quantity=quantity)
...
def create_checkout_session():
    ...
    return render_template("checkout_session.html")
