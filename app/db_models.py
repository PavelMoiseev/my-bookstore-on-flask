...
class User(UserMixin, db.Model):
    ...
    cart = db.relationship('Cart', cascade="all,delete", backref='buyer')
    orders = db.relationship("Order", cascade="all,delete", backref='customer')
...
class Item(db.Model):
    ...
    orders = db.relationship("Ordered_item", cascade="all,delete", backref="item")
    in_cart = db.relationship("Cart", cascade="all,delete", backref="item")
...
class Order(db.Model):
    ...
    items = db.relationship("Ordered_item", cascade="all,delete", backref="order")
